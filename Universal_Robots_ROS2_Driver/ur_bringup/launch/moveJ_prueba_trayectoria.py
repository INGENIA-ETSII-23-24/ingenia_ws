...
def main(args=None):
    ...
    file_path = './src/Universal_Robots_ROS2_Driver/ur_bringup/config/20240425_medio_cilindro_poses_quat_en_m.csv'
    ...
    while True:
        ...
        goal_names.pose.position.x, goal_names.pose.position.y, goal_names.pose.position.z, goal_names.pose.orientation.w, goal_names.pose.orientation.x, goal_names.pose.orientation.y, goal_names.pose.orientation.z = position
