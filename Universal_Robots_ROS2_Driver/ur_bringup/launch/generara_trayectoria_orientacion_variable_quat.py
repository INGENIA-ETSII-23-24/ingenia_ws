...
#EN ESTA VERSIÓN, FINALMENTE SE USAN LOS QUATERNIONES EN FORMATO  x y z w. SEGÚN LA TEORÍA DEBEN SER UNITARIOS.
...
with open('./src/Universal_Robots_ROS2_Driver/ur_bringup/config/points_quaternion.csv', 'w', newline='') as csvfile:
